...
# Description: R-script underlying all analyses presented in Höhne et al. "Distance from spawning grounds is the main driver of life-history variation in European eels across the Mediterranean"
...
Rerun <- 0    # When this switch is activated (1), all statistical models in this script will be run. 
...
# 4.5) Visualize the environmental effects on sex ratio
